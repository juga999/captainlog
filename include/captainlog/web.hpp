...
public:
    ...
    expected<bool, std::string> handle_about_request(struct evhttp_request* req);
    ...
    expected<bool, std::string> handle_get_svg_request(struct evhttp_request* req, std::string&& svg_file);
